...
public class schedule {
    ...
    public void studyTimeResetDay(){
        ...
        for (MemberInfo mI : memberInfoList) {
            List<MemberRoomLog> memberRoomLogList = mrlRepository.findBymember_id(mI.getId()).stream().filter((m)->m.getJoinedAt().toDate().before(ttime)).collect(Collectors.toList());
